...
public class UploadedEvents extends AppCompatActivity {
    private RecyclerView hosted_recycler;
    private com.example.pramodn.myapplication.event_adapter.hosted_adapter hosted_adapter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        requestQueue= Volley.newRequestQueue(UploadedEvents.this);

        utility=new utility();
        hosted_model = new ArrayList<>();
        hosted_adapter = new hosted_adapter(UploadedEvents.this, hosted_model);
        RecyclerView.LayoutManager mLayoutManager1 = new GridLayoutManager(UploadedEvents.this, 1);
        LinearLayoutManager linearLayoutManager1 = new LinearLayoutManager(UploadedEvents.this, LinearLayoutManager.VERTICAL, true);
    ...
    private void Load_data_from_DB() {
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, utility.ip+utility.home,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        Toast.makeText(UploadedEvents.this, response, Toast.LENGTH_SHORT).show();
