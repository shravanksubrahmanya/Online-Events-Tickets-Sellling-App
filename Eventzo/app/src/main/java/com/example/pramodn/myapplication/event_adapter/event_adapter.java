...
public class event_adapter extends RecyclerView.Adapter<event_adapter.MyViewHolder> {
    ...
    private List<event_model> albumList1;
    RequestQueue queue;
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        public TextView event_id, event_name,event_description,nolike,nocomment;
        public ImageView event_iamge;
        public RelativeLayout category_main_layout;
        public Button view_more;
        public  ImageView event_image;
        public ImageButton likes,comments;
    ...
    public event_adapter(Context mContext, List<event_model> albumList1) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.event_adapter_layout, parent, false);
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        final event_model album = albumList1.get(position);

        holder.event_name.setText(album.getEvent_name());
        holder.event_description.setText(album.getEvent_synopsis());
